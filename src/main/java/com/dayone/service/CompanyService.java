...
public class CompanyService {
    ...
    public Company save(String ticker) {
        ...
        if (exists) {
            throw new RuntimeException("already exists company ->" + ticker);
        }
    ...
    public List<String> autocomplete(String keyword) {
        return (List<String>) this.trie.prefixMap(keyword).keySet().stream().limit(5).collect(Collectors.toList());
    }
